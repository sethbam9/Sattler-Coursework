...
def loadData():
    db = r"C:\Users\sethb\OneDrive\Desktop\Sattler College\5. Fall 2020\CS 202 Object-Oriented Design\Liturgy App\liturgy.db"
...
pref = SettingsDatabase(r"C:\Users\sethb\OneDrive\Desktop\Sattler College\5. Fall 2020\CS 202 Object-Oriented Design\Liturgy App\liturgy.db")
...
class PrayerDevoScreen(Screen):
    ...
    def playAudio(self, x):
        sound = SoundLoader.load(r"C:\Users\sethb\OneDrive\Desktop\Sattler College\5. Fall 2020\CS 202 Object-Oriented Design\Liturgy App\Psalms audio\%s.mp3" % (self.ch))
        if sound:
            sound.play()
